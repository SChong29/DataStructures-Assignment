...
class AVLTreeMapTest {
    ...
    void testEntrySet()  {
        ...
        String esString = map.entrySet().toString();
        // Verify the string representation of entrySet, not the direct call to toString()
        assertEquals("[1, 2, 4, 5, 12, 15, 21, 23, 24, 26, 33, 35]", esString);
    }
